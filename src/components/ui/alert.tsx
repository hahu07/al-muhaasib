...
const Alert = React.forwardRef<HTMLDivElement, AlertProps>(
  ({ variant = "default", className = "", children, ...props }, ref) => {
    ...
    const variantClasses = {
      ...
      destructive:
        "border-red-500/50 text-red-900 dark:text-red-400 bg-red-50 dark:bg-red-950/50",
      success:
        "border-green-500/50 text-green-900 dark:text-green-400 bg-green-50 dark:bg-green-950/50",
      warning:
        "border-yellow-500/50 text-yellow-900 dark:text-yellow-400 bg-yellow-50 dark:bg-yellow-950/50",
    };
