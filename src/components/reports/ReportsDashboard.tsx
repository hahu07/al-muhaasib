...
import { useRealtimeReports, useReportsSummary } from '@/hooks/useRealtimeReports';
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
              ...
              <div>
                ...
                <Select 
                  ...
                  onValueChange={(value) => handleFilterChange('format', value as 'monthly' | 'quarterly' | 'yearly')}
                >
                  <SelectTrigger>
                    <SelectValue />
                  </SelectTrigger>
            ...
            <CardContent className="p-4">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-2xl font-bold text-purple-600">₦8,500,000</p>
                </div>
  ...
  const renderReport = () => {
    switch (activeReport) {
      case 'income-statement':
        return <IncomeStatementReport filters={filters} onBack={() => setActiveReport('overview')} />;
      case 'balance-sheet':
        return <BalanceSheetReport filters={filters} onBack={() => setActiveReport('overview')} />;
      case 'cash-flow':
        return <CashFlowReport filters={filters} onBack={() => setActiveReport('overview')} />;
      case 'trial-balance':
        return <TrialBalanceReport filters={filters} onBack={() => setActiveReport('overview')} />;
      case 'asset-register':
        return <AssetRegisterReport filters={filters} onBack={() => setActiveReport('overview')} />;
      case 'depreciation-schedule':
        return <DepreciationScheduleReport filters={filters} onBack={() => setActiveReport('overview')} />;
      default:
