...
const FEE_TYPES: { value: FeeType; label: string; description: string }[] = [
  {
    value: "tuition",
    label: "Tuition",
    description: "Academic fees for teaching and instruction",
  },
  {
    value: "uniform",
    label: "Uniform",
    description: "School uniform and clothing costs",
  },
  {
    value: "feeding",
    label: "Feeding",
    description: "Meal and nutrition program fees",
  },
  {
    value: "transport",
    label: "Transport",
    description: "Transportation and bus service fees",
  },
  {
    value: "books",
  ...
  },
  {
    value: "sports",
    label: "Sports",
    description: "Sports and athletics program fees",
  },
  {
    value: "development",
    label: "Development",
    description: "School development and improvement fees",
  },
  {
    value: "examination",
    label: "Examination",
  ...
  },
  {
    value: "computer",
    label: "Computer",
    description: "Computer lab and ICT fees",
  },
  {
    value: "library",
    label: "Library",
    description: "Library services and maintenance fees",
  },
  {
    value: "laboratory",
    label: "Laboratory",
    description: "Science laboratory fees and equipment",
  },
  {
    value: "lesson",
    label: "Extra Lessons",
    description: "After-school and additional lesson fees",
  },
  {
    value: "other",
    label: "Other",
    description: "Miscellaneous fees not covered above",
  },
];
        ...
        <div className="animate-pulse space-y-4">
          ...
          <div className="space-y-3">
            {[...Array(5)].map((_, i) => (
              <div
                key={i}
                className="h-16 rounded bg-gray-100 dark:bg-gray-700/50"
              ></div>
            ))}
          </div>
        </div>
      ...
      <div className="overflow-hidden rounded-lg border border-gray-200 bg-white shadow-sm dark:border-gray-700 dark:bg-gray-800">
        {categories.length === 0 ? (
          <div className="py-12 text-center">
            <TagIcon className="mx-auto mb-4 h-12 w-12 text-gray-400 dark:text-gray-500" />
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              ...
              <select
                value={formData.type}
                onChange={(e) =>
                  setFormData({ ...formData, type: e.target.value as FeeType })
                }
                className="w-full rounded-lg border border-gray-300 bg-white px-3 py-2 text-gray-900 focus:border-blue-500 focus:ring-2 focus:ring-blue-500 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-100"
                required
              >
