...
export async function initializeExpenseCategories(): Promise<void> {
  try {
    ...
    console.log(
      "No expense categories found. Initializing default categories...",
    );
  ...
  return [
    {
      ...
      category: "allowances",
      description: "Transport, housing, and other staff allowances",
    },
    {
      name: "Equipment Purchase",
      category: "equipment_purchase",
      description: "Purchase of school equipment and furniture",
    },
    {
      name: "Food & Catering",
      category: "food_supplies",
      description: "School feeding and catering supplies",
    },
    {
    ...
    },
    {
      ...
      category: "legal_fees",
      description: "Legal, audit, and professional service fees",
    },
    {
      name: "Insurance",
      category: "insurance",
    ...
    },
    {
      ...
      description: "Other expenses not covered by specific categories",
    },
  ];
}
